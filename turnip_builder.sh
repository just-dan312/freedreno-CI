...
{
  "schemaVersion": 1,
  "name": "Mesa Turnip Adreno Driver 24.0.4",
...
zip -r $workdir/turnip-24.0.4-A10-compat.adpkg.zip * &> /dev/null
if ! [ -a $workdir/turnip-24.0.4-A10-compat.adpkg.zip ];
	then echo -e "$red-Packing failed!$nocolor" && exit 1
	else echo -e "$green-All done, you can take your module from here;$nocolor" && echo $workdir/turnip-24.0.4-A10-compat.adpkg.zip
fi
